...
def generate_story(era: str, place: str, characters: str, topic: str) -> StorySchema:
    ...
    for attempt in range(settings.llm_max_retries):
        ...
        retry_hint = "REMINDER: Output ONLY the JSON object. scenes array must have exactly 4 items. emotion must be one of: happy, sad, curious, surprised, tense, calm, warm, magical.\n"
